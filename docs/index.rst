...
xafs.xrayabsorption.org
================================================

.. _xrayabsorption.org:   https://xrayabsorption.org/

xafs.xrayabsorption.org (also xafs.org) is a community site for x-ray
absorption fine-structure (XAFS) and related spectroscopies. It is part of
the web pages sponsored by the International XAFS Society,
https://xrayabsorption.org/.
...
An energy-tunable X-ray source is needed to measure XAFS.  This typically
means that a synchrotron source is used, but some laboratory-based systems
do exist.
